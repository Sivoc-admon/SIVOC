          ...
          <div class="modal-body">
            <div class="container-fluid">
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <select class="form-control" id="project_id" name="project_id">
                                ...
                                @if (Auth::user()->hasAnyRole(['admin', 'compras', 'finanzas', 'direccion']))
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            <label for="">Justificacion de la requisición:</label>
                            <textarea class="form-control" name="commentPrincipal" id="commentPrincipal" cols="20" rows="4"></textarea>
                        </div>
                    </div>
                </div>
                <div class="row">
